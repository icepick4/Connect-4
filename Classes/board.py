...
class Board:
    ...
    def drawPawn(self, game):
        ...
        for i in range(game.rows):
            for j in range(game.columns):
                if pawns[i][j] == 1:
                    pygame.draw.circle(self.screen, (180,0,0), (self.x + j * self.x + self.x /2,self.y + i * self.y + self.y /2), 55, 5)
                    pygame.draw.circle(self.screen, (255,60,60), (self.x + j * self.x + self.x /2,self.y + i * self.y + self.y /2), 50)
                elif pawns[i][j] == 2:
                    pygame.draw.circle(self.screen, (160,150,5), (self.x + j * self.x + self.x /2,self.y + i * self.y + self.y /2), 55, 5)
    ...
    def seePawn(self, col, game, color):
        ...
        pygame.draw.circle(self.screen, borderColor, (self.x + col * self.x + self.x /2,self.y + ctr * self.y + self.y /2), 55, 5)
